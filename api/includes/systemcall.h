...
#define SYSTEM_CALL_GET_PROC_LIST		105

#define SYSTEM_CALL_PRINT				110

#define SYSTEM_CALL_OPEN_DEVICE			120
#define SYSTEM_CALL_CLOSE_DEVICE		121
...
#define SYSTEM_CALL_IPC_LIST			155
