\section{Virtelle Speicherverwaltung}
...
\lstinputlisting[language=C, caption=Struktur für first-level Deskriptoren, label=codeFirstLevelDescriptor]{codefiles/firstLevelDescriptor.c}
...
\lstinputlisting[language=C, caption=Struktur für second-level Deskriptoren, label=codeSecondLevelDescriptor]{codefiles/secondLevelDescriptor.c}
...
\lstinputlisting[language=C, caption=Struktur für die Verwaltung von Speicherregionen, label=codeMemoryRegion]{codefiles/region.c}
\vspace{0.5cm}
...
\lstinputlisting[language=C, caption=Funktion für direktes Mapping in die master page table, label=codeMasterPageTableMapping]{codefiles/directMapIntoMasterPageTable.c}
...
\lstinputlisting[language=C, caption=Aktivierung der MMU, label=codeMMUInit]{codefiles/MMUInit.c}
...
\lstinputlisting[language=C, caption=Softwareschnittstelle der MMU, label=codeMMUFunctions]{codefiles/MMUFunctions.c}
\vspace{0.5cm}
