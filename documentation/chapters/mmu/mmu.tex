...
\lstinputlisting[language=C, caption=Struktur für first-level Deskriptoren, label=codeFirstLevelDescriptor]{chapters/mmu/codefiles/firstLevelDescriptor.c}
...
\lstinputlisting[language=C, caption=Struktur für second-level Deskriptoren, label=codeSecondLevelDescriptor]{chapters/mmu/codefiles/secondLevelDescriptor.c}
...
\lstinputlisting[language=C, caption=Struktur für die Verwaltung von Speicherregionen, label=codeMemoryRegion]{chapters/mmu/codefiles/region.c}
\vspace{0.5cm}
...
\lstinputlisting[language=C, caption=Funktion für direktes Mapping in die master page table, label=codeMasterPageTableMapping]{chapters/mmu/codefiles/directMapIntoMasterPageTable.c}
...
\lstinputlisting[language=C, caption=Aktivierung der MMU, label=codeMMUInit]{chapters/mmu/codefiles/MMUInit.c}
...
\lstinputlisting[language=C, caption=Softwareschnittstelle der MMU, label=codeMMUFunctions]{chapters/mmu/codefiles/MMUFunctions.c}
\vspace{0.5cm}
