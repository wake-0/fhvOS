...
\lstinputlisting[language=C, caption=Allgemeine Schnittstelle des DriverManagers, label=driverManagerInterface]{chapters/driver/codefiles/driverManager-interface.c}

\lstinputlisting[language=C, caption=Implementierung der DriverManager Schnittstelle für den LED Treiber, label=driverManagerImplementation]{chapters/driver/codefiles/driverManager-implementation.c}
